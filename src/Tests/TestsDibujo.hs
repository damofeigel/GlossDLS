...
testrot45 :: Test
testrot45 = TestCase (assertEqual "rotar45"  "Rot45 (Figura 1)" (show $ rot45 $ figura 1))
...
testmapDib :: Test
testmapDib = TestCase (assertEqual "mapDib" expectedmadDib (show $ mapDib (rotar . figura) dibujo))
